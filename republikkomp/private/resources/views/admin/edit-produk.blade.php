                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="{{ url('product-del', [$data->id]) }}" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="form-group">
                                                    <label for="inputText3" class="col-form-label">Nama Produk</label>
                                                <input id="inputText3" value="{{$data->nama}}" name="nama" type="text" class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputText4" class="col-form-label">Harga</label>
                                                    <input id="inputText4" name="harga" value="{{$data->harga}}" type="number" class="form-control" placeholder="Masukan Angka" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputPassword">Kategori</label>
                                                    <input id="inputPassword" name="kategori" value="{{$data->kategori}}" type="text" placeholder="Kategori" class="form-control" required>
                                                </div>
                                                <img style="width:200px;heigth:200px;" src="{{ url('private/images', [$data->foto]) }}" alt="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="ket"
                                                     id="exampleFormControlTextarea1" rows="3" required>{{$data->ket}}</textarea>
                                                </div>
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
